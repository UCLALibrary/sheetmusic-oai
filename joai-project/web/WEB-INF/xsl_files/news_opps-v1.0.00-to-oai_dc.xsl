...
<xsl:stylesheet 
    ...
    exclude-result-prefixes="xsi d n" 
...
<!--Date created: 2005-02-16 by Katy Ginger, University Corporation for Atmospheric Research (UCAR)-->

<!--Last modified: 2006-03-31 by Katy Ginger-->
...
<!--To transform Digital Library for Earth System Education (DLESE) news and opportunities metadata records to simple Dublin Core that uses the Open Archives Initiative (OAI) namespace-->
