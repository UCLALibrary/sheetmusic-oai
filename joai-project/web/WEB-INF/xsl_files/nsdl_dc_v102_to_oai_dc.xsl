...
<!-- =============================================================  
 "nsdl_dc_v102_to_oai_dc" stylesheet 

Transform nsdl_dc v1.02 metadata to oai_dc by dumbing down Qualified Dublin Core Refinements to their equivalent simple DC elements; leaving the simple DC elements alone, and dropping all other elements. Looks for explicitly named elements in nsdl_dc and xforms them.

Note that this transform will only work with the correct version of nsdl_dc (v1.02).
