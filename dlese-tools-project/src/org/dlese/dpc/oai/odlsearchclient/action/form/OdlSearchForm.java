...
/**
 *  A Struts Form bean for handling remote search results returned in responst to a DLESE
 *  ODL search request.
 *
 * @author    John Weatherley
 * @see       org.dlese.dpc.oai.odlsearchclient.action.OdlSearchAction
 */
public final class OdlSearchForm extends ActionForm implements Serializable {
