...
public class MdeComplexType extends MdeNode {
	...
	private void render_edit_mode() {
		...
		if (getLevel() != 0) {
			...
			Element elementPath = DocumentHelper.createElement("c__set")
		...
		if (getLevel() == 0) {
			parentExists = DocumentHelper.createElement("div");
		...
		controlElement = DocumentHelper.createElement("div");
...
*/
	...
	public Element getRequiredMultiSelectControl() {
		...
		Element actionElement = DocumentHelper.createElement("span")
	...
	protected Element getChoiceDeleteController(String itemPath, String elementName) {
		...
		Element deleteItemAction = DocumentHelper.createElement("span")
			.addAttribute("class", "action-button");
	...
	protected Element getRepeatComplexSingletonControl() {
		...
		Element newItemControl = DocumentHelper.createElement("logic__lessThan")
			.addAttribute("name", formBeanName)
