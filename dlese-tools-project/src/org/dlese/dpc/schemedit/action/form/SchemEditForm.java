...
*/
	...
	public String getNodeIsExpandable(String key) {
		...
		*/
		...
		// ensure that choice nodes are expanded (so choice is always visible)
		SchemaNode schemaNode = this.schemaHelper.getSchemaNode (xpath);
		if (docMap.nodeExists(xpath) && schemaNode.hasChoiceCompositor())
			return TRUE;
