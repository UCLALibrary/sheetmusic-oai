...
/**
 *  Reads am XML configuration file for a ASN vocab display and suggestion service. All frameworks are configured in the
 same file, and include per-framework properties such as the framework, the ASN docs configured for that framework,
 the xpath of the vocab field, the plugin for each framework, etc.
 *
 *@author    ostwald
 */
