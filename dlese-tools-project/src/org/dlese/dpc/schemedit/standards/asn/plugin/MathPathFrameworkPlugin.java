 ...
 * @author    ostwald
 */
public class MathPathFrameworkPlugin extends NcsItemFrameworkPlugin {

	/**
	 *  initialize the MathPathFrameworkPlugin object so that the suggestion service is deactivated.
	 *
	...
	/**
	 *  Gets the optionalCatUIFields attribute of the MathPathFrameworkPlugin object
	 *
	...
	public String[] getRecordSubjects() {
		List subjectPaths = Arrays.asList(
			...
			"/record/general/subjects/interdisciplinaryConnectionsSubject",
	...
	public String getSubjectPath() {
		return "/record/general/subjects/mathSubject";
	}
