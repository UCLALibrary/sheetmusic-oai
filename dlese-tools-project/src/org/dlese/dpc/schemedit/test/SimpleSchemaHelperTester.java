...
/* 		List nodes = SchemaUtils.getDerivedTextOnlyNodes(this.sh);
	...
	void osmTester () throws Exception {
		...
		prtln ("isRequiredContent: " + sh.isRequiredContentElement(schemaNode));
	...
	void msp2Tester () throws Exception {
		...
		if (schemaNode.isRequired())
			...
			prtln ("NOT required");
		if (this.xmlFormat.equals("adn") && sh.isRequiredContentElement(schemaNode)) {
