...
import org.dlese.dpc.xml.NSDLDCNormalizer;
import org.dlese.dpc.xml.NSDLDCNormalizerXpathException;
				...
				if (isStatusDone) {
					...
					if (formatTypeToIndex.equals("canonical_nsdl_dc") && formatToIndex.equals("nsdl_dc")) {
						...
						if (nsdlDcNormalizer != null) {
							...
							itemRecord = nsdlDcNormalizer.normalizeNsdlDcRecord(itemRecord, mdHandle, resourceHandles, uniqueId, requiredXpaths);
						}
					}
					// Native format:
					else {
