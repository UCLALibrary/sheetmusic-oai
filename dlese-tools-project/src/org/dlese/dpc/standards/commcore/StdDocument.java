...
public class StdDocument {
	...
	private void init() throws Exception {
		...
		Element stdDocElement = (Element) doc.selectSingleNode("/" + rootElementName + "/Document");
		...
		List lsItems = doc.selectNodes("/" + rootElementName + "/Standard");
...
/* 		String filename = "comm_core-07-13_converted-07-30.xml";
