...
public class AsnStatement {
	...
	private String asnIdentifier; // asn purl, e.g., http://purl.org/ASN/resources/S1009A52
	...
	public AsnStatement(Element e) {
		this.element = e;
		statementId = e.attributeValue("about");
		asnIdentifier = getSubElementResource("identifier");
	...
	/**
	 *  Gets the ADN id for this statement
	 *
	 * @return    The id value
	 */
	public String getId() {
		return asnIdentifier;
	}
