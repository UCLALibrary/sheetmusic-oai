...
public class NDRConstants {
	...
	static public final String NCS_PROD_AGENT        = "2200/NCS";
	...
	static public final String DEFAULT_USER_AGENT = "NDR API Proxy";
	
	/**
	* Convenience method to assign values to the values required for signed request to NDR.
	 * @param  ndrApiBaseUrl  baseUrl for NDR API services, for example http://ndr.nsdl.org/api
	 * @param  ncsAgentHandle    agent to be associated with requests (not necessary for read operations)
	 * @param  privateKeyPath     path to privateKeyFile for specified agent ((not necessary for read operations)
	 * @param  userAgent     userAgent associated with requests to NDR API
	*/
	public static void init (String ndrApiBaseUrl, String ncsAgentHandle, String privateKeyPath, String userAgent) {
