...
/* 	public InputXML getInputXML() {
	...
	public InfoXML submit(String inputXMLStr) throws Exception {
		...
		InfoXML proxyResponse = null;
		try {
			proxyResponse = new InfoXML(connection.request());
		} catch (java.net.SocketTimeoutException ste) {
			String errorMsg = "Read timed-out after " + connection.getReadTimeout() + " milliseconds";
			errorMsg += " (timeout specified by NDRConstants.NDR_CONNECTION_TIMEOUT)";
