...
public class SerializedDataManager extends DataManager implements Serializable {
	...
	protected Object restoreSerializedObject(String oid, boolean fromCache)
		...
		try {
			...
			throw new IOException("Problem accessing file at '" + f + "': " + t.getMessage());
		} finally {
			if (useFileLocks)
	...
	protected static void prtln(String s) {
		if (debug)
			System.out.println(getDateStamp() + " " + getClassName() + ": " + s);
	}
	...
	protected static void prtlnErr(String s) {
		System.err.println(getDateStamp() + " " + getClassName() + " ERROR: " + s);
	}
