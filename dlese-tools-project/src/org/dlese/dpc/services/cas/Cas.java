...
public class Cas {
	...
	private static String userAgent = "Creator Acknowledgement System";
	...
	void getAllRecords()
		...
		do {
			...
			try {
				...
				InputStream istm = TimedURLConnection.getInputStream(url,timeOutPeriod,userAgent);
					...
					if (dbmat.length == 0) {
						...
						if (newtohistory == true) {
							...
							try {
								...
								InputStream istm_acc = TimedURLConnection.getInputStream(url_acc,timeOutPeriod_acc,userAgent);
