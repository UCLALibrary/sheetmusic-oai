...
public final class SimpleLuceneIndex {
	...
	*/
	...
	private void init() {
		...
		// If read-only, load reader and searcher:
		else {
	 ...
	 *
	 * @exception  WriteNotPermittedException  NOT YET DOCUMENTED
	 */
	 ...
	 * @exception  WriteNotPermittedException  If read-only
	 */
	public boolean addDoc(Document doc) throws WriteNotPermittedException {
	 ...
	 * @exception  WriteNotPermittedException  If read-only
	 */
	public boolean addDoc(Document doc, boolean block) throws WriteNotPermittedException {
		return update(null, (String[]) null, new Document[]{doc}, block);
	}
	 ...
	 * @exception  WriteNotPermittedException  If read-only
	 */
	public boolean addDocs(Document[] docs) throws WriteNotPermittedException {
	 ...
	 * @exception  WriteNotPermittedException  If read-only
	 */
	public boolean addDocs(Document[] docs, boolean block) throws WriteNotPermittedException {
		return update(null, (String[]) null, docs, block);
	}
	...
	public boolean update(String deleteField,
	                      String[] deleteValues,
	                      Document[] addDocs) throws WriteNotPermittedException {
	...
	public boolean update(
	                      String deleteField,
	                      ArrayList deleteValues,
	                      ArrayList addDocs) throws WriteNotPermittedException {
		return update(deleteField, deleteValues, addDocs, BLOCK);
	}
	 ...
	 * @see                                    #isIndexing()
	 */
	public void stopIndexing() throws WriteNotPermittedException {
		if (isReadOnly)
			throw new WriteNotPermittedException("Can not stop indexer.");
	 ...
	 * @exception  WriteNotPermittedException  If read-only
	 */
	public void performOptimization() throws WriteNotPermittedException {
		if (isReadOnly)
			throw new WriteNotPermittedException("Optimization not permitted");
		synchronized (_updateLock) {
			IndexWriter tmpWriter = null;
			try {
