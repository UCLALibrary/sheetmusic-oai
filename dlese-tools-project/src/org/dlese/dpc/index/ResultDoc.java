...
public class ResultDoc implements Comparable, Serializable {
	...
	private LazyDocumentMapValuesArray lazyDocumentMapValuesArray = null;
	...
	/**
	 *  Gets a {@link org.dlese.dpc.index.reader.LazyDocumentMapValuesArray} of all field/values contained in the
	...
	public LazyDocumentMapValuesArray getLazyDocumentMapValuesArray() {
		if (lazyDocumentMapValuesArray == null)
			lazyDocumentMapValuesArray = new LazyDocumentMapValuesArray(getDocument());

		return lazyDocumentMapValuesArray;
	}
