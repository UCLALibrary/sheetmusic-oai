...
public class DleseCollectionDocReader extends XMLDocReader {
	...
	/**
	 *  Gets the short title of the collection directly from the XML record, or the full title if not available.
	 *
	...
	public String getNumIndexed() {
		return Integer.toString(getPrimaryIndex().getNumDocs("collection:0" + getKey()));
	}
	...
	public String getNumIndexingErrors() {
		return Integer.toString(getPrimaryIndex().getNumDocs("error:true AND docdir:\"" +
