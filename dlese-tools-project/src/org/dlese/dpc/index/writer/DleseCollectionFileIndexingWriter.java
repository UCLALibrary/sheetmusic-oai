...
public class DleseCollectionFileIndexingWriter extends XMLFileIndexingWriter {
	...
	protected String getFullTitle() throws Exception {
		return getDom4jDoc().valueOf("/*[local-name()='collectionRecord']/*[local-name()='general']/*[local-name()='fullTitle']");
	}
	...
	protected String getShortTitle() throws Exception {
		return getDom4jDoc().valueOf("/*[local-name()='collectionRecord']/*[local-name()='general']/*[local-name()='shortTitle']");
	}
	...
	protected final void addFields(Document newDoc, Document existingDoc, File sourceFile)
		...
		if (value == null)
			value = "";
		newDoc.add(new Field("key", value, Field.Store.YES, Field.Index.NOT_ANALYZED));
