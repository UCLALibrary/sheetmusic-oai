 ...
 *  All rights reserved.
 */
package org.dlese.dpc.serviceclients.peopledb;
...
public class PositionHistory {
	...
	/**
	 *  Constructor for the PositionHistory object with provided upid
	 *
	 * @param  upid  UCAR People ID (e.g., 2457)
	 */
	public PositionHistory(String upid) {
		try {
			openDB();

			List all_positions = getRawPositionHistory(upid);
			positions = prunePositionHistory(all_positions);
	 ...
	 */
	List getRawPositionHistory(String upid) throws MmdException {
		// query the "position_history" table for upid
		Object[][] dbmat;
	 ...
	 */
	List prunePositionHistory(List positions) {
