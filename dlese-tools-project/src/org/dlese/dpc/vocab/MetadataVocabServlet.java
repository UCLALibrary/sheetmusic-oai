...
public class MetadataVocabServlet extends HttpServlet {
	...
	public synchronized void loadVocabs() {
		...
		if ( newVocabsChecker == null ) {
			...
			MetadataVocab vocab = ((RepositoryManager)getServletContext().getAttribute( "repositoryManager" )).getMetadataVocab();
	...
	public static void synchWithCollectionManager( ServletContext context ) {
		...
		MetadataVocab vocab = (rm == null? null : rm.getMetadataVocab());
	...
	*/
	...
	private final void prtlnErr( String s ) {
		System.err.println( getDateStamp() + " MetadataVocabServlet: " + s );
	}
	...
	private final static void prtln( String s ) {
		if ( debug ) {
			System.out.println( getDateStamp() + " MetadataVocabServlet: " + s );
		}
	}
