...
public class IndexingManager {
	...
	private DDSServlet ddsServlet = null;
	 ...
	 * @param  ddsServlet         Description of the Parameter
	 */
	public IndexingManager(RepositoryManager repositoryManager, DDSServlet ddsServlet) {
		collectionIndexer = new CollectionIndexer(repositoryManager, this);
		this.repositoryManager = repositoryManager;
		this.ddsServlet = ddsServlet;
		try {
	...
	public synchronized void startIndexingTimer(String indexingStartTime, String indexingDaysOfWeek) throws Exception {
		...
		doPerformContinuousIndexing = false;
	...
	private class IndexingManagerTimerTask extends TimerTask {
		...
		public void run() {
			...
			try {
				...
				if (doPerformContinuousIndexing || _indexingDaysOfWeek == null) {
