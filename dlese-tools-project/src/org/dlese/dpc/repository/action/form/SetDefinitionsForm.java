...
/**
 *  Bean for values used to add/edit OAI set definitions. Note: A set must be defined using EITHER
 *  matchingFieldValues OR a query as defined by any of the includedDirs/excludedDirs, includedTerms, etc.<p>
 *
 *  Note: matchingFieldValues is used by DDS and DCS, not currently by jOAI.
 *
...
public final class SetDefinitionsForm extends ValidatorForm implements Serializable {
	...
	// Define a set using matchingFieldValues (colon-separated Strings for each):
	private String[] matchingFieldValues = new String[0];
	...
	public String toString() {
		return "SetDefinitionsForm: setSpec: " + setSpec + " setName: " + setName + " setDescription: " + setDescription;
	}
	...
	public void reset() {
		...
		matchingFieldValues = new String[0];
	}
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		// Note: For now, no validation is done for matchingFieldValues. Logic should be either use matchingFieldValues *OR* a virtual query parameter
	...
	/**
	 *  Gets the matching Lucene field/value pairs that defines this set, for example
	 *  ["collection:dcc","collection:dwel"].
	 *
	 * @return    One or more field/value pairs delimited by colons.
	 */
	public String[] getMatchingFieldValues() {
	 ...
	 *  ["collection:dcc","collection:dwel"]. The record is considered in the set if at least one of the
	 *  field/value pairs is stored in the Lucene Document for that record.
	 *
	 * @param  matchingFieldValues  The new matchingFieldValues value
	 */
	public void setMatchingFieldValues(String[] matchingFieldValues) {
		this.matchingFieldValues = matchingFieldValues;
	}
