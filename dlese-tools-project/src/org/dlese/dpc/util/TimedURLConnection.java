 ...
 *  <p>
 *
 *  Default http User-Agent is set to 'DLESETools TimedURLConnection' unless otherwise specified. <p>
 *
...
public class TimedURLConnection {
	...
	private final static String defaultUserAgent = "DLESETools TimedURLConnection";
	...
	public static String importURL(String url, String postData, String characterEncoding, int timeOutPeriod, String userAgent)
		...
		InputStream istm = getInputStream(new URL(url), postData, timeOutPeriod, userAgent);
