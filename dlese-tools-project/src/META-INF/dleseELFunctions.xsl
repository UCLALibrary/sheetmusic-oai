  ...
  <xsl:template match="/el:taglib">
    <html>
      ...
      <body>
		...
		<p>
			To use the DLESE EL functions, include the DLESETools.jar Java library in the web applicatation classpath.
		...
		<p>
			See the 
			<a href="http://java.sun.com/j2ee/1.4/docs/tutorial/doc/JSPIntro7.html" target="_blank">JSP 2.0 Expression Language tutorial</a>.
		</p>		
		<p>Return to <a href="overview-summary.html">DLESE Tools Javadoc</a>.</p>
		<br/>
